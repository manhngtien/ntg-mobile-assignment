  ...
  return (
    <Background>
      <View style={[atoms.flex_1, { backgroundColor: theme.colors.gray_50 }]}>
        ...
        <ScrollView showsVerticalScrollIndicator={false} style={[atoms.flex_1, atoms.p_4]}>
          <YStack gap={24}>
            {/* Profile Info */}
            <YStack
              gap={0}
            ...
            >
              ...
              <Text style={[atoms.text_sm, atoms.mb_2, { color: theme.colors.gray_500 }]}>
                @{user?.username}
              </Text>
              <View
                style={[
            ...
            >
              <View style={[atoms.flex_row, atoms.justify_between, atoms.items_center]}>
                <Text
                  style={[
                    atoms.text_lg,
                    atoms.font_semibold,
                ...
                <TouchableOpacity onPress={() => {}}>
                  <Text style={[atoms.text_sm, atoms.font_semibold, { color: theme.colors.cyan }]}>
                    Edit Details
                  </Text>
                </TouchableOpacity>
              </View>
              ...
              <YStack gap={16}>
                <YStack gap={4}>
                  <Text
                    style={[atoms.text_xs, atoms.font_medium, { color: theme.colors.gray_400 }]}
                  >
                    EMAIL ADDRESS
                  </Text>
                  <View
                ...
                <YStack gap={4}>
                  ...
                  <View style={[atoms.py_2, atoms.px_3, atoms.rounded_xl]}>
              ...
              >
                ...
                >
                  <XStack gap={12}>
                    ...
                    <Text
                      style={[atoms.text_base, atoms.font_medium, { color: theme.colors.gray_700 }]}
                    >
                      Order History
                    </Text>
                  </XStack>
              ...
              >
                ...
                >
                  <XStack gap={12}>
                    ...
                    <Text
                      style={[atoms.text_base, atoms.font_medium, { color: theme.colors.red_500 }]}
                    >
                      Logout
                    </Text>
                  </XStack>
